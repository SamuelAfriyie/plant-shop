...
import 'package:shop/pages/feed/feed.dart';
import 'package:shop/pages/post/post.dart';
import 'package:shop/pages/profile/profile.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  bool isAdmin = false;
  Future<List<DocumentSnapshot<Map<String, dynamic>>>>? plants;
  ...
  void status() async {
    ...
    final v = await state.checkStatus(context);
    setState(() {
      isAdmin = v;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: NestedScrollView(
                        ...
                        Container(
                          ...
                          child: CupertinoTextField(
                            ...
                            onChanged: (String value) {
                              PlantService state = Provider.of<PlantService>(
                                  context,
                                  listen: false);
                                ...
                                () {
                                  if (value.isEmpty) {
                                    ...
                                    Future.delayed(
                                        ...
                                        () async => plants = state.searchPlants(
                                            searchText: value));
                                  }
                                },
                              );
        ...
        body: FeedPlantPage(key: widget.key, searchedPlants: plants),
      ),
    );
  }
}
