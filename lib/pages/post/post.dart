...
import 'package:shop/utility/utils.dart';
...
class _PostPageState extends State<PostPage> {
  ...
  Future<void> getImage(
    ...
    print("Cropped Start Image successfully");
    ...
    return Scaffold(
      ...
      floatingActionButton: Container(
        ...
        child: GestureDetector(
          onTap: () {
            print("entered the onclick button");
            if (_plants == null ||
                _pot.text.isEmpty ||
                _price.text.isEmpty ||
            ...
            uploadRepository.uploadPlants(_plants!).then((String? value) async {
