...
import 'package:shop/widget/card.dart';
import 'package:staggered_grid_view_flutter/widgets/staggered_grid_view.dart';
import 'package:staggered_grid_view_flutter/widgets/staggered_tile.dart';

class FeedPlantPage extends StatefulWidget {
  final Future<List<DocumentSnapshot<Map<String, dynamic>>>>? searchedPlants;
  const FeedPlantPage({super.key, this.searchedPlants});
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      ...
      child: FutureBuilder<List<DocumentSnapshot<Map<String, dynamic>>>>(
        future: widget.searchedPlants ?? plants,
